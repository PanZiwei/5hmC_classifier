#!/usr/bin/bash
###SLURM HEADER
#SBATCH --job-name=sep_T4_sup
#SBATCH --output=/fastscratch/c-panz/2021-10-08/log/chrom_sep_sup_T4.log
#SBATCH --err=/fastscratch/c-panz/2021-10-08/log/chrom_sep_sup_T4.err
...
fast5_dir=/fastscratch/c-panz/2021-10-07/guppy5.0.14.sup.tombo/T4LambdaTF1
