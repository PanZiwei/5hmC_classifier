...
#SBATCH --output=/fastscratch/c-panz/2021-11-29/log/deepsignal_custom_install.log
#SBATCH --err=/fastscratch/c-panz/2021-11-29/log/deepsignal_custom_install.err
...
# create
conda env remove --name deepsignal_custom_1129
conda create -n deepsignal_custom_1129 python=3.6
# activate
