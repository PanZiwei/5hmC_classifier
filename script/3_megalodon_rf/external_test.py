...
load the model -> load the data -> get the cv result on training dataset -> save the test score/class report/confusion matrix/confusion matrix visualization on testing dataset
