#!/usr/bin/bash
#SBATCH --job-name=mega_5mC
#SBATCH --mail-type=ALL
#SBATCH --mail-user=ziwei.pan@jax.org
#SBATCH --output=/fastscratch/c-panz/2021-09-11/log/5mC_guppy5.0.14_%a.out  # %A: job ID 
#SBATCH --error=/fastscratch/c-panz/2021-09-11/log/5mC_guppy5.0.14_%a.err
...
#SBATCH --array=[0-3773]%200  #The array number can be calculated from 
###SLURM HEADER
date
...
FAST5_PATH=/pod/2/li-lab/Ziwei/Nanopore/data/single_read/5mCLambdaTF1_200
FASTA_REF=/pod/2/li-lab/Ziwei/Nanopore/data/reference/hg38_lambda.fa
