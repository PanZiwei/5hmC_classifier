#!/usr/bin/bash
###SLURM HEADER
#SBATCH --job-name=1101_tsne_umap
#SBATCH --output=/pod/2/li-lab/Ziwei/Nanopore/daily/2021-11-01/tsne_umap.log
#SBATCH --err=/pod/2/li-lab/Ziwei/Nanopore/daily/2021-11-01/tsne_umap.err
