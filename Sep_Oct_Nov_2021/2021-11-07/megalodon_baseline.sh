...
#SBATCH --output=/pod/2/li-lab/Ziwei/Nanopore/daily/2021-11-07/megalodon.log
#SBATCH --err=/pod/2/li-lab/Ziwei/Nanopore/daily/2021-11-07/megalodon.err
...
python $script_dir/megalodon_baseline.py --input_path $input_file --output_path $script_dir/result > $script_dir/megalodon.txt
