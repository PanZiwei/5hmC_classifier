...
num_feature=57504 # 53360+296*14 (5hmC:5mC:5C = 1:14:14)
...
head -53360 $output_path/lambda_5mC.tsv > $output_path/lambda_5mC.train.tsv
tail -4144 $output_path/lambda_5mC.tsv > $output_path/lambda_5mC.valid.tsv
head -53360 $output_path/lambda_5C.tsv > $output_path/lambda_5C.train.tsv
...
### Problem: Right now I can't use GPU because there is a error saying that 
