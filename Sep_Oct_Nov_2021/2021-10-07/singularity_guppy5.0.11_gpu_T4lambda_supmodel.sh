#!/usr/bin/bash
###SLURM HEADER
#SBATCH --job-name=T4_5011 # A single job name for the array
#SBATCH --error=/fastscratch/c-panz/2021-10-07/log/T4lambda_sup_5011_%a.err # %A: job ID %a:job array index
#SBATCH --output=/fastscratch/c-panz/2021-10-07/log/T4lambda_sup_5011_%a.log # %A: job ID %a:job array index
