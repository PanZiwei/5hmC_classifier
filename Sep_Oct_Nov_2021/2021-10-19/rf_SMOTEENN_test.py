#! /usr/bin/env python3
"""
Oct 18, 2021, Ziwei Pan
The script is for: Combination of SMOTE  and Edited Nearest Neighbors Undersampling
1. Split the sample into training and testing datasets
2. SMOTE to oversample to balance the distribution, then ENN to remove misclassified examples from all classes
...
if __name__ == '__main__':
    ...
    # Make the pipeline
    pipe_smote_rf = imbpipeline(steps = [('r', resample),
