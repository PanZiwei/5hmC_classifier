...
#SBATCH --error=/fastscratch/c-panz/2021-09-30/log/setup.err # %A: job ID %a:job array index
#SBATCH --output=/fastscratch/c-panz/2021-09-30/log/setup.log # %A: job ID %a:job array index
