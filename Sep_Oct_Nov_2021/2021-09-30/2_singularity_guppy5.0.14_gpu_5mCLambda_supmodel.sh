...
#SBATCH --error=/fastscratch/c-panz/2021-09-30/log/guppy.tombo/5mClambda_supmodel_%a.err # %A: job ID %a:job array index
#SBATCH --output=/fastscratch/c-panz/2021-09-30/log/guppy.tombo/5mClambda_supmodel_%a.log # %A: job ID %a:job array index
