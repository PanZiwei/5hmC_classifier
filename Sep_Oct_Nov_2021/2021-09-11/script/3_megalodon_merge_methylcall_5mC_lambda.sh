#!/usr/bin/bash
#SBATCH --job-name=5mC_lambda
#SBATCH --output=/fastscratch/c-panz/2021-09-11/log/merge_5mClambda.out  # %A: job ID 
#SBATCH --error=/fastscratch/c-panz/2021-09-11/log/merge_5mClambda.err
...
##T4: KJ477685.1
##Lambda: J02459.1
awk '$1 == "J02459.1"' $OUTPUT_DIR/$Prefix.per_read_modified_base_calls.sorted.bed > $result_dir/$Prefix.Megalodon.methyl_call.perRead.bed
echo "5mC_Lambda extracting is done!"
