...
#SBATCH --array=0-3774  #The array number can be calculated from 
###SLURM HEADER
#Install guppy
#singularity version
#.tar.gz verison
...
#(megalodon2.3.3) [c-panz@sumner-log1 taiyaki]$ conda list taiyaki
# packages in environment at /projects/li-lab/Ziwei/Anaconda3/envs/megalodon2.3.3:
#
