...
cm_analysis(y_test, y_pred, os.path.join(output_path, 'confusion_matrix_100_10_10.png'),
...
df.to_csv(os.path.join(output_path, 'class_report_100_10_10.csv'), header = True, index= None, sep = ',', float_format='%.4f')
