...
cm_analysis(y_test, y_pred, os.path.join(output_path, 'confusion_matrix_10_25_10.png'),
...
df.to_csv(os.path.join(output_path, 'class_report_10_25_10.csv'), header = True, index= None, sep = ',', float_format='%.4f')
