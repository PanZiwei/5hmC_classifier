...
#SBATCH --output=/fastscratch/c-panz/2021-11-21/log/5mC_lambda.log
#SBATCH --err=/fastscratch/c-panz/2021-11-21/log/5mC_lambda.err
...
deepsignal extract --fast5_dir $lambda_5mC --reference_path $ref_dir/Lambda_phage.fa --write_path $output_dir/$prefix.tsv --corrected_group RawGenomeCorrected_001 --nproc 100 --methy_label 1
