#!/usr/bin/bash
#SBATCH --job-name=rf_gpu
#SBATCH --output=/fastscratch/c-panz/2021-09-15/log/rf_gpu.out  # %A: job ID 
#SBATCH --error=/fastscratch/c-panz/2021-09-15/log/rf_gpu.err
...
python -u $script_dir/rf_up_09152021.py > $result_dir/rf_up_09152021.txt