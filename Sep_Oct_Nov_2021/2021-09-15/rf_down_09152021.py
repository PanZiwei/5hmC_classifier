...
print('Mean f1_macro: %.3f' % np.mean(f1_macro))
...
cm_analysis(y_test, y_pred, os.path.join(output_path, 'confusion_matrix_downsamping.png'),
...
df.to_csv(os.path.join(output_path, 'class_report_downsamping.csv'), header = True, index= None, sep = ',', float_format='%.4f')
