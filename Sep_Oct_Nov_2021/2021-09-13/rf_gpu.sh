...
#SBATCH --output=/fastscratch/c-panz/2021-09-13/log/rf_gpu.out  # %A: job ID 
#SBATCH --error=/fastscratch/c-panz/2021-09-13/log/rf_gpu.err
...
python -u $script_dir/rf.py > $result_dir/rf_gpu.txt