#!/usr/bin/bash
###SLURM HEADER
#SBATCH --job-name=rf_random
#SBATCH --output=/pod/2/li-lab/Ziwei/Nanopore/daily/2021-11-13/rf_RandomSearch.log
#SBATCH --err=/pod/2/li-lab/Ziwei/Nanopore/daily/2021-11-13/rf_RandomSearch.err
...
python $script_dir/rf_ratio_RandomSearch.py --input_path $input_file --output_path $script_dir/result > $script_dir/rf_RandomSearch.txt
