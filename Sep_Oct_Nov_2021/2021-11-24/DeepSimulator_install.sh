#!/usr/bin/bash
###SLURM HEADER
#SBATCH --job-name=DeepSimulator
#SBATCH --output=/fastscratch/c-panz/2021-11-24/log/DeepSimulator.log
#SBATCH --err=/fastscratch/c-panz/2021-11-24/log/DeepSimulator.err
...
software_dir=/pod/2/li-lab/Ziwei/software
cd $software_dir
