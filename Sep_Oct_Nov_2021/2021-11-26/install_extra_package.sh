#!/usr/bin/bash
###SLURM HEADER
#SBATCH --job-name=default_deepsignal
#SBATCH --output=/fastscratch/c-panz/2021-11-26/log/deepsignal_default.log
#SBATCH --err=/fastscratch/c-panz/2021-11-26/log/deepsignal_default.err
...
conda install libblas==3.9.0
conda install libcblas==3.9.0   
conda install cudatoolkit
conda install cudnn

CUDA_VISIBLE_DEVICES=0 deepsignal train --train_file $output_path/feature.train.tsv --valid_file $output_path/feature.valid.tsv --model_dir $output_path --class_num 3
