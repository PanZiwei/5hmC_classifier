...
#SBATCH --output=/fastscratch/c-panz/2021-11-26/log/deepsignal_custom_install.log
#SBATCH --err=/fastscratch/c-panz/2021-11-26/log/deepsignal_custom_install.err
