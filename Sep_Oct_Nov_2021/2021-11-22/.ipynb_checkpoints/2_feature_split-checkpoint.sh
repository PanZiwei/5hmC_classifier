#!/usr/bin/bash
###SLURM HEADER
#SBATCH --job-name=feature_split
#SBATCH --output=/fastscratch/c-panz/2021-11-22/log/feature_split.log
#SBATCH --err=/fastscratch/c-panz/2021-11-22/log/feature_split.err
...
#### Use minimum requirement: 512*1000 samples = 512000 #change display number = 1000
num_feature=516144 # 512000+296*14 (5hmC:5mC:5C = 1:14:14)
...
# 4. split samples for training/validating(9:1) (training: 1024512, testing: 113835)
head -512000 $output_path/lambda_5mC.tsv > $output_path/lambda_5mC.train.tsv
tail -4144 $output_path/lambda_5mC.tsv > $output_path/lambda_5mC.valid.tsv
head -512000 $output_path/lambda_5C.tsv > $output_path/lambda_5C.train.tsv
