...
#SBATCH --output=/fastscratch/c-panz/2021-10-23/log/rf_SMOTE_GridSearch.log
#SBATCH --err=/fastscratch/c-panz/2021-10-23/log/rf_SMOTE_GridSearch.err
...
python $script_dir/rf_SMOTE_GridSearch.py --input_path $input_file --output_path $script_dir/result > $script_dir/rf_SMOTE_GridSearch.txt
