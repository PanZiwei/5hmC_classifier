#!/usr/bin/bash
###SLURM HEADER
#SBATCH --job-name=rf_RandomSearch
#SBATCH --output=/fastscratch/c-panz/2021-12-08/log/rf_RandomSearch.log
#SBATCH --err=/fastscratch/c-panz/2021-12-08/log/rf_RandomSearch.err
...
python $script_dir/rf_RandomSearch_212.py --input_path $input_file --output_path $script_dir/result > $script_dir/rf_RandomSearch_212.txt
