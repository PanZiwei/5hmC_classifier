#! /usr/bin/env python3
"""
Dec 8, 2021, Ziwei Pan
The script is to Divide the datasets into Training, validation, testing -> Downsampling validating and testing dataset -> SMOTE training dataset and train the random forest with RandomSearch on validation dataset for best parameter -> Testing the classifier on the testing datasets
1. Extract 2 features(P(5hmC), P(5mC))
2. Split the sample into training, validation, testing datasets = 8:1:1
3. Downsampling validation and testing datasets with ratio 0(5C):1(5mC):2(5hmC) = 2:1:2, SMOTE training datasets
4. RandomSearch to find the best parameter on the training dataset
5. Validate the classifer on the remaining fold
6. Save the classification report and confusion matrix plotting for default parameter
"""
import pandas as pd
import numpy as np
import sys, os
...
if __name__ == '__main__':
    ...
    ### Use PredefinedSplit since I have a custom validation set
    ...
    # Use PredefinedSplit in RandomSearch
    ########### Random Search
