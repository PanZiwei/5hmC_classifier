#!/usr/bin/bash
###SLURM HEADER
#SBATCH --job-name=5C_deepsignal
#SBATCH --output=/fastscratch/c-panz/2021-11-22/log/deepsignal_custom_extract_5C.log
#SBATCH --err=/fastscratch/c-panz/2021-11-22/log/deepsignal_customextract_5C.err
...
deepsignal extract --fast5_dir $path_5C --reference_path $ref_dir/Lambda_phage.fa --write_path $output_dir/$prefix.tsv --corrected_group RawGenomeCorrected_001 --nproc 100 --methy_label 0
echo "5C feature extraction is done!"
