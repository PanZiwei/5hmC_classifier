...
#SBATCH --output=/fastscratch/c-panz/2021-12-06/log/rf_GridSearch.log
#SBATCH --err=/fastscratch/c-panz/2021-12-06/log/rf_GridSearch.err
...
python $script_dir/rf_GridSearch.py --input_path $input_file --output_path $script_dir/result > $script_dir/rf_GridSearch.txt
