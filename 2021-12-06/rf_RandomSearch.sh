...
#SBATCH --output=/fastscratch/c-panz/2021-12-06/log/rf_RandomSearch.log
#SBATCH --err=/fastscratch/c-panz/2021-12-06/log/rf_RandomSearch.err
...
python $script_dir/rf_RandomSearch.py --input_path $input_file --output_path $script_dir/result > $script_dir/rf_RandomSearch.txt
