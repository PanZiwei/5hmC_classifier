...
if __name__ == '__main__':
    ...
    model = RandomForestClassifier(random_state=42, n_jobs = -1) ##2021-10-08: not sure whether it is the key to get the best result or not
    ...
    #Define rf classifier: 3*3*3*3*2=162
    params = {
